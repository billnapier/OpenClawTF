...
1. **Strict Documentation Parity (Principle 7)**:
   - The onboarding skill (`openclaw.bootstrap`) and `docs/Quickstart.md` must implement identical GCP API lists, secret names, WIF configurations, and environment variable schemas.
